...
import com.smartapps.jmdb.ui.screens.MyTextField3
import com.smartapps.jmdb.ui.screens.MyTextFieldDark
import com.smartapps.jmdb.ui.screens.MyTextFieldNum
import com.smartapps.jmdb.ui.screens.form6.Form6UiEvent
import com.smartapps.jmdb.ui.screens.intro.IntroUiEvent
...
//                    .size(18.dp))
            ...
            MyTextField(
                ...
                onEvent = {
                    onEvent(Form1UiEvent.UpdateTitle(it))
                })
            ...
            MyTextField(label = "Phone 1", value = uiState.value.phone1, onEvent = {
            ...
            Box {
                ...
                MyTextField3(label = "Date of birth", value = uiState.value.dob, onChange = {
...
//            }
            ...
            MyTextField2(
                label = "Nationality",
                value = uiState.value.nationality,
                items = listOf("Nigeria"),
                callback = { x, y ->
                    onEvent(Form1UiEvent.UpdateNationality(x, y))
                })
            Spacer(modifier = modifier.height(15.dp))
            ...
            MyTextField2(
                ...
                items = listOf("Jos"),
                callback = { x, y ->
                    onEvent(Form1UiEvent.UpdateState(x, y))
                })
            Spacer(modifier = modifier.height(15.dp))
            ...
            Dialog(onDismissRequest = { }) {
                Box(modifier = modifier.fillMaxSize()) {
                    ...
                    Column(
                        ...
                        Text(text = "Saving step 1...",fontSize = 12.sp,color = Color.White, fontWeight = FontWeight.SemiBold, modifier = modifier.clickable {
