...
//            Spacer(modifier = modifier.height(15.dp))
            ...
            MyTextField(label = "Plot No.", value = uiState.value.plNo, onEvent = {
            ...
            Dialog(onDismissRequest = { }) {
                Box(modifier = modifier.fillMaxSize()) {
                    ...
                    Column(
                        ...
                        Text(text = "Saving Box 2...",fontSize = 12.sp,color = Color.White, fontWeight = FontWeight.SemiBold, modifier = modifier.clickable {
